                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form method="post" id="form-submit" action="{{ url(strtolower(auth::user()->role).'/update_password') }}">
                                    @csrf
                                    ...
                                    <div class="row gx-3 mb-1">
                                        <div class="col-md-12">
                                            ...
                                            <input class="form-control" type="text"  autocomplete="off" name="current_password" id="current_password" required value="{{old('current_password')}}" />
