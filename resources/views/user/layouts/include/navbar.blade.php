@php
    ...
    $notifications = Notification::where(['type' => 'User',  'user_id' => auth()->user()->id])->get();
@endphp
    ...
    <div class="navbar-container d-flex content">
        <div class="bookmark-wrapper d-flex align-items-center">
            ...
            <ul class="nav navbar-nav bookmark-icons">
                ...
                <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ url(strtolower(auth()->user()->role).'/application') }}" data-toggle="tooltip" data-placement="top" title="My Application"><i class="ficon" data-feather="activity"></i></a></li>
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                    ...
                    <li class="scrollable-container media-list">
                        @forelse ($notifications as $notification)
                            <a class="d-flex" href="{{ url('/user/notification/delete/'.$notification->id) }}">
                    ...
                    @if (count($notifications) > 0)
                        <li class="dropdown-menu-footer"><a class="btn btn-primary btn-block" href="{{ url('/user/notification/all/delete') }}">Read all notifications</a></li>
                    @endif
                </ul>
            </li>
