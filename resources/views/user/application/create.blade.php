@extends('user.layouts.app') @section('title', 'Create Application')
@section('css')
                    ...
                    <div class="bs-stepper-content">
                        {{-- <form method="post" action="{{ url('/user/application/store') }}"> --}}
                            ...
                            <div id="" class="content @if ($tab === "Personal") active dstepper-block @endif">
                                ...
                                <form method="post" id="form-submit" action="{{ url('/user/application/personal/update/'.$application->id) }}">
                                    @csrf
                                    <div class="row">
                            ...
                            <div id="" class="content @if ($tab === "Education") active dstepper-block @endif">
                                ...
                                @if (count($applicationEducations) > 0)
                                    <form method="post" action="{{ url('/user/application/education/update/'.$application->id) }}">
                                        @csrf
                                                ...
                                                @if ($key != 0) <div> @endif
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group @if ($key == 0) col-md-2 @else col-md-4 @endif">
                                                            ...
                                                            <input type="date" class="form-control" id="education_start_date" name="education_start_date[]" value="{{ $education->start_date }}" />
                                                        </div>
                                                        <div class="form-group @if ($key == 0) col-md-2 @else col-md-4 @endif">
                                                            <label class="form-label">End Date</label>
                                                            <input type="date" class="form-control"  id="education_end_date" name="education_end_date[]" value="{{ $education->end_date }}" />
                                                        </div>
                                                        @if ($key == 0)
                                                            <div class="form-group col-md-4">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <a href="{{ url('/user/application/edit/'.$application->application_id."?tab=Personal") }}" class="btn btn-primary btn-prev">
                                                <i data-feather="arrow-left" class="align-middle mr-sm-25 mr-0"></i>
                                                <span class="align-middle d-sm-inline-block d-none">Previous</span>
                                            </a>
                                        ...
                                        <div class="education_wrapper">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <label class="form-label">Start Date</label>
                                                    <input type="date" class="form-control" id="education_start_date" name="education_start_date[]" />
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <label class="form-label">End Date</label>
                                                    <input type="date" class="form-control" id="education_end_date" name="education_end_date[]" />
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label class="form-label" style=""></label>
                                                    <button type="button" class="btn btn-primary w-100 add_more_education">Add More</button>
                            ...
                            <div id="" class="content @if ($tab === "Professional") active dstepper-block @endif">
                                ...
                                @if (count($applicationProfessionals) > 0)
                                    <form method="post" action="{{ url('/user/application/professional/update/'.$application->id) }}">
                                        @csrf
                                            ...
                                            @foreach ($applicationProfessionals as $key => $professional)
                                                @if ($key != 0) <div> @endif
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group @if ($key == 0) col-md-3 @else col-md-4 @endif">
                                                            <label class="form-label">Start Date</label>
                                                            <input type="date"  class="form-control" id="professional_start_date" name="professional_start_date[]" value="{{ $professional->start_date }}" />
                                                        </div>
                                                        <div class="form-group @if ($key == 0) col-md-3 @else col-md-4 @endif">
                                                            <label class="form-label">End Ddate</label>
                                                            <input type="date"  class="form-control" id="professional_end_date" name="professional_end_date[]" value="{{ $professional->end_date }}" />
                                                        </div>
                                                        @if ($key == 0)
                                                            <div class="form-group col-md-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <a href="{{ url('/user/application/edit/'.$application->application_id."?tab=Education") }}" class="btn btn-primary btn-prev">
                                                <i data-feather="arrow-left" class="align-middle mr-sm-25 mr-0"></i>
                                                <span class="align-middle d-sm-inline-block d-none">Previous</span>
                                            </a>
                                            <button type="submit" data-toggle="modal" data-target="#Loading" class="btn btn-primary btn-next">
                            ...
                            <div id="" class="content @if ($tab === "Review") active dstepper-block @endif">
                                ...
                                <div class="d-flex justify-content-between">
                                    <a href="{{ url('/user/application/edit/'.$application->application_id."?tab=Professional") }}" class="btn btn-primary btn-prev">
                                        <i data-feather="arrow-left" class="align-middle mr-sm-25 mr-0"></i>
                                        <span class="align-middle d-sm-inline-block d-none">Previous</span>
                                    </a>
                                    <form id="form-submit" action="{{ url('/user/application/complete/save/'.$application->id) }}">
                                        <button data-toggle="modal" data-target="#Loading" type="submit" class="btn btn-success">Submit</a>
                                    </form>
                                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#education_start_date').on('change', function() {
            $("#education_end_date").attr({"max" : '2200-01-01', "min" : this.value   });
        });

        $('#professional_start_date').on('change', function() {
            $("#professional_end_date").attr({"max" : '2200-01-01', "min" : this.value   });
        });
