    ...
    <div class="content-wrapper">
        <div class="content-body">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="form-submit" method="post" action="{{ url('/admin/document/request/update/'.$document->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2">                            
                            <div class="form-group col-md-4">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="id_proof" name="id_proof" @if ($document->id_proof == "Yes") checked @endif value="Yes">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="name_change_evidence" name="name_change_evidence" @if ($document->name_change_evidence == "Yes") checked @endif value="Yes">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="work_experience_letter" name="work_experience_letter" @if ($document->work_experience_letter == "Yes") checked @endif value="Yes">
                        ...
                        <div class="row mb-2">                            
                            <div class="form-group col-md-4">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="appointment_letter" name="appointment_letter" @if ($document->appointment_letter == "Yes") checked 
                                    @endif value="Yes">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="pay_slips" name="pay_slips" @if ($document->pay_slips == "Yes") checked @endif value="Yes">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="resume" name="resume" @if ($document->resume == "Yes") checked @endif value="Yes">
                        ...
                        <div class="row mb-2">                            
                            <div class="form-group col-md-4">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="salary_statement" name="salary_statement" @if ($document->salary_statement == "Yes") checked @endif value="Yes">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="apprenticeship_certificate" name="apprenticeship_certificate" @if ($document->apprenticeship_certificate == "Yes") checked @endif value="Yes">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="affidavit" name="affidavit" @if ($document->affidavit == "Yes") checked @endif value="Yes">
