...
class ApplicationController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('admin.application.create', compact('application', 'applicationEducations', 'applicationProfessionals'));
    }
    ...
    public function view($id)
    {
    	...
    	$applicationProfessionals = ApplicationProfessional::where('application_id', $application->id)->get();
    	// dd($applicationEducations);
        return view('admin.application.view', compact('application', 'applicationEducations', 'applicationProfessionals'));
    }
    ...
    public function status(Request $request, $id)
    {
        ...
        $application->isSubmited = $request->isSubmited;
        $application->employment_verication = $request->employment_verication;
        $application->save();
        Notification($application->user_id, 'User', '<b>'.auth::user()->name.'</b>'.' has update status to '.'<b>'.$application->status.'</b>'.'...');
    ...
    public function personal_update(Request $request, $id)
    {
    	...
    	return redirect('/admin/application/edit/'.$application->application_id."?tab=Education");
    	// $application->
    }
    ...
    public function education_update(Request $request, $id)
    {
    	...
    	return redirect('/admin/application/edit/'.$application->application_id."?tab=Professional");
    	// $application->
    }
    ...
    public function professional_update(Request $request, $id)
    {
    	...
    	return redirect('/admin/application/edit/'.$application->application_id."?tab=Review");
    	// $application->
    }
    ...
    public function save($id)
    {
        ...
        $application->save();
        return redirect('/admin/application')->with('flash_message_success', 'Successfully...');
    }
